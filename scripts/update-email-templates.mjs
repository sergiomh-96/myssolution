...
const styles = `
  ...
  .header-title { color:#ffffff; font-size:20px; font-weight:700; margin:12px 0 0; letter-spacing:-0.3px; }
  .body { padding:40px; }
...
<html lang="es">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Invitación</title>
<style>${styles}</style></head>
<body>
<div class="wrapper">
  <div class="header">
    <div class="header-title">MYSAIR CRM</div>
  </div>
  <div class="body">
    ...
    <hr class="divider">
    <p class="note">
      Este enlace es válido durante 24 horas. Si no esperabas esta invitación, puedes ignorar este correo.<br>
      Si el botón no funciona, copia y pega este enlace en tu navegador:<br>
      <a href="{{ .ConfirmationURL }}">{{ .ConfirmationURL }}</a>
    </p>
  </div>
  <div class="footer">MYSAIR CRM &mdash; Sistema de gestión de clientes y ofertas</div>
</div>
</body></html>`

// ─── Reset password template ──────────────────────────────────────────────────
const resetSubject = 'Restablecer contraseña — MYSAIR CRM'
const resetBody = `<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Restablecer contraseña</title>
<style>${styles}</style></head>
<body>
<div class="wrapper">
  <div class="header">
  ...
  <div class="body">
    <p class="greeting">Solicitud de restablecimiento de contraseña</p>
    <p class="text">
      Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en <strong>MYSAIR CRM</strong>.<br>
    ...
    <hr class="divider">
    <p class="note">
      Este enlace es válido durante 1 hora. Si no solicitaste este cambio, ignora este correo: tu contraseña no será modificada.<br>
